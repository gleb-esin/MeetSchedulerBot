...
public interface MeetingRepository extends CrudRepository<Meeting, Long> {
    ...
    @Query(value = "SELECT u.month FROM Meeting m WHERE m.passphrase = :passphrase AND m.owner = true", nativeQuery = true)
    String findMonthByPassphrase(@Param("passphrase") String passphrase);
